  ...
  template: `
    <div class="hero">
      ...
      <p class="lede">
        ...
        profile can identify you. Everything below is verifiable in the source.
      </p>
    </div>
    ...
    <div class="card">
      ...
      <p>
        ...
        only way to change or delete the profile. Each phrase is run through Argon2id — a
        memory-hard key derivation that forces every guess to chew through 64&nbsp;MiB of RAM — to
        derive an address on the server and an AES-256-GCM encryption key. The server sees only the
    ...
    <div class="card">
      ...
      <p class="sub">
        ...
        GPU-months to a GPU-year — a real curtain, not a vault door. The creature’s accent color is
        computed from the public three words alone. One thing on screen does reflect the tail: the
        page’s location banner shows the <em>kind</em> of place your last word names — one of twelve
        landscapes, drawn as its own pattern, never the word itself. That publishes about 3.5 bits
        to anyone holding the phrase already, which is why the lists grew to 4,096: the extra 3 bits
        pay for it, leaving the tail’s effective secrecy where it was (~32.4 bits) while giving you
        a place you can actually picture and remember. Your edit control never rests on any of this.
        “New creature” re-mints the whole view phrase: every old link, QR code, and desire
        fingerprint dies instantly, and that is the unlink lever.
      </p>
    </div>
    ...
    <div class="card">
      ...
      <p>
        ...
        comparisons weigh each side's score by what that person said matters — so “fit for you” and
        “fit for them” are honestly different numbers.
      </p>
    </div>
    ...
    <div class="card">
      ...
      <p>
        ...
        group in any form. Deposit pseudonymously and the roster shows a random two-word alias;
      ...
      <div class="notice-warn notice">
        ...
        snapshots, not live profiles — refresh yours after big changes. And the server, while unable
        to read anything, does see how many deposits each group holds and could notice which
        profiles are active around the same moments a group is — a traffic pattern, not content.
      </div>
    </div>
    ...
    <div class="card">
      ...
      <p>
        ...
        message box: intents come from a fixed list, and escalation is a deliberate choice — attach
        your view phrase (they see your creature) or a contact card (they learn who you are
        elsewhere; Menagerie can’t take that back). The recipient can reply exactly once through a
        one-shot reply box, or delete the boop and you will never know. Regenerating your creature
      ...
      <div class="notice-warn notice">
        ...
        does see that your inbox received sealed notes, when (hour-coarsely), and how many are
        waiting; anyone who can view your profile can also notice when your inbox stops accepting
        because it’s full. And a contact card, once revealed, is knowledge in a person’s head — no
        re-mint reaches it.
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="notice-warn notice">
        ...
        encoded in any form, so they are genuinely unknowable. Mark a desire only if you’d be
        comfortable with an enthusiastic match knowing it.
      </div>
    </div>
    ...
    <div class="card">
      ...
      <p class="sub">
        ...
        delete, or serve stale ciphertext — a nuisance that denies availability, never reads data,
        and is detected the moment decryption fails. Compared to the old links-carry-everything
        design, a server now exists and sees traffic at all: that’s the trade that makes typeable
    ...
    <div class="card">
      ...
      <p>
        ...
        partnership; friends who want to know if they’d survive a road trip. The survey treats every
        one of those as a first-class outcome, not a niche.
      </p>
    </div>
    ...
    <div class="card">
      ...
      <p>
        ...
        <a href="https://github.com/Randolin/Menagerie/blob/main/LICENSE" rel="noreferrer"
          >AGPL-3.0</a
        >
        — anyone may use, study, and self-host it, and anyone who runs a modified version as a
        service must share their modifications under the same license. The full source lives at
        <a href="https://github.com/Randolin/Menagerie" rel="noreferrer"
          >github.com/Randolin/Menagerie</a
        >. The app is a static bundle (GitHub Pages works); the server is a single Node file with
