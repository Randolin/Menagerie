...
@Component({
  ...
  template: `
    <div class="card no-print">
      <h1 style="margin-top:0">Backup card</h1>
      <p class="sub">
      ...
      <div class="notice-warn notice">
        ...
        this profile — printing it puts full control on a piece of paper. Don't leave it on a shared
        printer, and don't photograph it onto a camera roll that syncs somewhere you wouldn't put a
        password.
      </div>
      <div class="btn-row" style="margin-top:14px">
        <button class="btn btn-primary" (click)="print()">🖨️ Print or save as PDF</button>
        <a class="btn btn-ghost" routerLink="/settings">Back to settings</a>
      </div>
    </div>
    ...
    @if (viewPhrase(); as view) {
      <div class="card backup-card">
        <div class="backup-head">
          @if (session.persona(); as persona) {
            ...
            <div>
              ...
              <p class="fine" style="margin:2px 0 0">Menagerie profile · saved {{ today }}</p>
            </div>
          }
        </div>

        <h3 style="margin-bottom:4px">View phrase — share this</h3>
        ...
        <h3 style="margin-bottom:4px">Edit phrase — keep this secret</h3>
        <p class="fine" style="margin-top:0">
      ...
      <div class="card"><p class="sub">No session — log in to print a card.</p></div>
    }
  `,
  styles: `
    .backup-head {
