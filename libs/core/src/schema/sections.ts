...
export const SECTIONS: readonly Section[] = [
  {
    ...
    privacy: 'open',
    blurb:
      'Everything is optional, and nothing here can identify you — your creature is your name.',
    items: [
      {
        id: 'ab.pn',
        type: 'multi',
        tier: 'core',
        label: 'Pronouns',
        options: ['she/her', 'he/him', 'they/them', 'she/they', 'he/they', 'any', 'ask me'],
      },
      {
        id: 'ab.age',
        type: 'choice',
  ...
  },
  {
    ...
    privacy: 'open',
    blurb:
      'All kinds of connection are welcome here — friendship, partnership, and everything around and between.',
    items: [
      {
        id: 'sk.friend',
        type: 'interest',
  ...
  },
  {
    ...
    privacy: 'open',
    blurb:
      'Especially useful for non-monogamous folks — but everyone has a structure, even if it’s "just us two."',
    items: [
      {
        id: 'st.ideal',
        type: 'multi',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        options: ['Fully separate', 'Shared expenses only', 'Partly merged', 'Fully merged'],
      },
      {
        id: 'pl.cohabit',
        type: 'choice',
  ...
  },
  {
    ...
    optIn: true,
    blurb:
      'Optional. These answers are never shown in the open — a desire is revealed only when both profiles marked it "If you are" or warmer. "Not for me" answers are never shared at all, not even in hashed form.',
    items: [
      {
        id: 'dp.pda',
        type: 'interest',
